...
**Thirty-eight calculations** there now, and
...
math is a pure tested module before it reaches a page — **843 tests** on
the thirty-two modules, plus **100** that render the page itself and check the
