...
**Forty calculations** there now, and
...
math is a pure tested module before it reaches a page — **888 tests** on
the thirty-four modules, plus **105** that render the page itself and check the
