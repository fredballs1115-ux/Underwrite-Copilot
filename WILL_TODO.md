...
kept growing since (#317, #319, #320, #322, #324, #325, #326, #328, #329, #331, #334, #336, #337, #338, #339, #341, #342, #344).
**Thirty-four calculations** there now, and
...
math is a pure tested module before it reaches a page — **745 tests** on
the twenty-eight modules, plus **87** that render the page itself and check the
