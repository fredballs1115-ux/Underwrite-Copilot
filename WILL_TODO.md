...
kept growing since (#317, #319, #320, #322, #324, #325, #326, #328, #329, #331, #334, #336, #337, #338, #339, #341, #342, #344, #345, #346, #347, #349, #350, #351, #352, #353, #354).
**Forty-two calculations** there now, and
...
math is a pure tested module before it reaches a page — **939 tests** on
the thirty-six modules, plus **111** that render the page itself and check the
