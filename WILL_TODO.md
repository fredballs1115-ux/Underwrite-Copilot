...
**Forty-one calculations** there now, and
...
math is a pure tested module before it reaches a page — **908 tests** on
the thirty-five modules, plus **108** that render the page itself and check the
