...
**Forty-five calculations** there now, and
...
math is a pure tested module before it reaches a page — **1,019 tests** on
the thirty-nine modules, plus **118** that render the page itself and check the
