...
**Forty-seven calculations** there now, and
...
math is a pure tested module before it reaches a page — **1,081 tests** on
the forty-one modules, plus **118** that render the page itself and check the
