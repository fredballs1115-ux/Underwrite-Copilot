...
kept growing since (#317, #319, #320, #322, #324, #325, #326, #328, #329, #331, #334, #336, #337, #338, #339).
**Thirty-one calculations** there now, and
...
math is a pure tested module before it reaches a page — **655 tests** on
the twenty-five modules, plus **77** that render the page itself and check the
