 ...
 * highlighted in mint — the "ranges, not hero numbers" idea as a glyph.
    ...
    <svg viewBox="0 0 32 32" className={className} aria-hidden>
      <defs>
        <linearGradient id={`${id}-g`} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#19606a" />
          <stop offset="1" stopColor="#0c383d" />
        </linearGradient>
      </defs>
      ...
      <rect x="14.2" y="9" width="3.6" height="15" rx="1.8" fill="#7fd6cc" />
