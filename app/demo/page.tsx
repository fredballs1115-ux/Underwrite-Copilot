      ...
      <header className="border-b border-line bg-paper">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="rounded-lg px-3.5 py-1.5 text-sm font-medium text-muted transition-colors hover:text-ink"
            >
              Sign in
            </Link>
            <Link
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-10">
        ...
        <div className="mt-6 rounded-2xl border border-line bg-surface p-5 shadow-card">
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <span className="rounded-full bg-caution/15 px-3 py-1 text-xs font-semibold text-caution">
              Caution
            </span>
          </div>
          ...
          <dl className="mt-4 grid grid-cols-3 gap-3 border-t border-line pt-4">
            {[
              ...
              <div key={label}>
                ...
                <dd className="mt-1 font-mono text-lg font-semibold leading-none tabular-nums">
                  {value ?? "—"}
                </dd>
              </div>
            ))}
