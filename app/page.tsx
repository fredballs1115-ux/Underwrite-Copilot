...
/** "The screen, running" — a slim dark strip tracing the six stages on the
 *  sample deal in a looping cascade (pure CSS, no client JS). Every line is
 ...
 *  screen readers get one static sentence. */
function ScreenRunStrip() {
