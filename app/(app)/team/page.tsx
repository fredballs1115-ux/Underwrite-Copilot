...
const MESSAGES: Record<string, { cls: string; text: string }> = {
  ...
  create: { cls: "bg-kill/10 text-kill", text: "Couldn't create the team — make sure migration 0007 has been run, then try again." },
  ...
  ownerleave: { cls: "bg-kill/10 text-kill", text: "Owners can't leave their own team. Transfer isn't supported yet — contact support." },
  config: { cls: "bg-kill/10 text-kill", text: "Team billing isn't configured yet (missing STRIPE_TEAM_PRICE_ID)." },
