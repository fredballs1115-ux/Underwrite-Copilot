...
/** Accessible switch for an email preference — submits on toggle, the server
 *  action persists and the page re-renders with the new state. */
export function EmailToggle({
  ...
  enabled: boolean;
  /** which preference this switch drives */
  field: "analysis" | "digest";
  label: string;
}) {
  return (
